"""
This is a python snake game developed by Musah Ibrahim Ali
The modules used in this project is Tkinter
Enjoy and follow me on github if you are interested in getting more fun projects
follow me on github at https://github.com/MIA-GH/
"""
from tkinter import *
import random
import time
...
lblTitle = Label(Tops, font=('arial', 50, 'bold'), text="Payroll Management Systems", fg="Steel blue", bd=10,
                 anchor="w")
...
txtEmployeeName = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="powder blue", justify="left",
...
txtAddress = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="powder blue", justify="left",
...
txtReference = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="powder blue", justify="left",
...
txtEmployerName = Entry(InsideLF, font=('arial', 12, 'bold'), bd=20, width=54, bg="powder blue", justify="left",
...
txtCity = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
                textvariable=City)
...
txtBasic = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
                 textvariable=Basic)
...
txtOverTime = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
...
lblGrossPay = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
...
lblNetPay = Entry(InsideLFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
                  textvariable=NetPay)
...
txtTax = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
               textvariable=Tax)
...
txtPension = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
...
txtStudenLoan = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
                      textvariable=StudenLoan)
...
txtNIPavment = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
...
txtDeducations = Entry(InsideLFR, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="right",
                       textvariable=Deducations)
...
txtPostCode = Entry(InsideRF, font=('arial', 12, 'bold'), bd=10, width=50, bg="powder blue", justify="right",
...
txtGender = Entry(InsideRF, font=('arial', 12, 'bold'), bd=10, width=50, bg="powder blue", justify="right",
                  textvariable=Gender)
...
txtPayDate = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="left",
                   textvariable=PayDate)
...
txtTaxPeriod = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="left",
...
txtNINumber = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="left",
...
txtNICode = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="left",
                  textvariable=NICode)
...
txtTaxablePay = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="left",
                      textvariable=TaxablePay)
txtTaxablePay.grid(row=4, column=1)

lblPensionablePay = Label(InsideRFL, font=('arial', 12, 'bold'), text="Pensionable Pay", fg="Steel blue", bd=10,
                          anchor="w")
lblPensionablePay.grid(row=5, column=0)
txtPensionablePay = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="left",
                          textvariable=PensionablePay)
txtPensionablePay.grid(row=5, column=1)

lblOtherPaymentDue = Label(InsideRFL, font=('arial', 12, 'bold'), text="Other Payment Due", fg="Steel blue", bd=10,
                           anchor="w")
lblOtherPaymentDue.grid(row=6, column=0)
txtOtherPaymentDue = Entry(InsideRFL, font=('arial', 12, 'bold'), bd=10, width=18, bg="powder blue", justify="left",
